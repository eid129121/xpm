...
function getPackageUrl(packageindex)
	...
	return string.format("https://raw.githubusercontent.com/eid129121/xpm/main/packages/%s/init.lua", package or game:HttpGet(string.format("https://raw.githubusercontent.com/boyangsic/xpm/main/packages/%s/latest",package)))
end
